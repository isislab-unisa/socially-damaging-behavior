...
// uncomment this to try out trails  (also need to uncomment out some others in this file, look around)
    ...
    public void setupPortrayals()
        ...
        if (w == h)
            { display.insideDisplay.width = display.insideDisplay.height = 600; }
        else if (w > h)
            { display.insideDisplay.width = 600; display.insideDisplay.height = 600 * (h/w); }
        else if (w < h)
            { display.insideDisplay.height = 600; display.insideDisplay.width = 600 * (w/h); }
