...
public abstract class Behaviour {
	...
	public abstract Double2D consistency(Agent agent,Bag b, Continuous2D humans);
	public abstract Double2D cohesion(Agent agent,Bag b, Continuous2D humans);
	public abstract Double2D avoidance(Agent agent,Bag b, Continuous2D humans);
}
